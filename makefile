...
main.obj: main.cpp intro.hpp player.hpp playerChoiceCatalogue.hpp sleepFor.hpp settings.hpp
...
playerChoiceCatalogue.obj: playerChoiceCatalogue.cpp playerChoiceCatalogue.hpp sleepFor.hpp player.hpp settings.hpp
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)
