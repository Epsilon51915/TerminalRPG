...
$(EXE_DIR)/$(EXECUTABLE_NAME): $(MAIN_OBJ) $(PLAYER_OBJ) $(INVENTORY_OBJ) $(ENEMY_OBJ) $(GAME_OBJ) $(TEXT_EDITOR_OBJ)
	mkdir -p $(EXE_DIR)
	$(CXX) -o $@ $^ $(LINK_FLAGS)
...
$(PLAYER_OBJ): $(PLAYER_CPP) $(PLAYER_HPP) $(INVENTORY_HPP) $(ENEMY_HPP) $(TEXT_EDITOR_HPP) $(COLORS_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)
...
$(GAME_OBJ): $(GAME_CPP) $(GAME_HPP) $(PLAYER_HPP) $(INVENTORY_HPP) $(ENEMY_HPP) $(TEXT_EDITOR_HPP) $(COLORS_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)
