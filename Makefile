...
ITEM_CPP = $(SRC_DIR)/item.cpp
ITEM_HPP = $(INCL_DIR)/item.hpp
ITEM_OBJ = $(OBJ_DIR)/item.o
...
TEXT_EDITOR_CPP = $(SRC_DIR)/textEditor.cpp
TEXT_EDITOR_HPP = $(INCL_DIR)/textEditor.hpp
TEXT_EDITOR_OBJ = $(OBJ_DIR)/textEditor.o
COLORS_HPP = $(INCL_DIR)/colors.hpp

$(EXE_DIR)/$(EXECUTABLE_NAME): $(MAIN_OBJ) $(PLAYER_OBJ) $(ITEM_OBJ) $(ENEMY_OBJ) $(GAME_OBJ) $(TEXT_EDITOR_OBJ)
	mkdir -p $(EXE_DIR)
	$(CXX) -o $@ $^ $(LINK_FLAGS)

$(MAIN_OBJ): $(MAIN_CPP) $(GAME_HPP) $(COLORS_HPP)
	mkdir -p $(OBJ_DIR)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)

$(PLAYER_OBJ): $(PLAYER_CPP) $(PLAYER_HPP) $(ITEM_HPP) $(ENEMY_HPP) $(TEXT_EDITOR_HPP) $(COLORS_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)

$(ITEM_OBJ): $(ITEM_CPP) $(ITEM_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)

$(ENEMY_OBJ): $(ENEMY_CPP) $(ENEMY_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)

$(GAME_OBJ): $(GAME_CPP) $(GAME_HPP) $(PLAYER_HPP) $(ITEM_HPP) $(ENEMY_HPP) $(TEXT_EDITOR_HPP) $(COLORS_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)

$(TEXT_EDITOR_OBJ): $(TEXT_EDITOR_CPP) $(TEXT_EDITOR_HPP)
	$(CXX) -c -o $@ $< $(COMPILE_FLAGS)
